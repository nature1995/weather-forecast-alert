...
def send_email(subject='Weather alert enroll successful<noreply@qq.com>', email='892714129@qq.com', content='Weather alert enroll successful'):
    send_mail(subject, content, '892714129@qq.com', [email], html_message=False)
    ...
    if request.method == 'POST':
        try:
            ...
            if cur_weather['ab'] <= 45.0:
                send_email(subject="Weather alert<noreply@qq.com>",email= emails[-1],content=content_text)
        ...
        try:
            em = request.GET['em']
            emails.append(em)
            send_email(subject='Weather alert enroll successful<noreply@qq.com>', email=emails[-1], content='Weather alert enroll successful')
            print(em)
